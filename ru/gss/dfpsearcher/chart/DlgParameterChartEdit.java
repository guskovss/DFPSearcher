...
import ru.gss.dfpsearcher.commons.DlgDirEdit;
import ru.gss.dfpsearcher.commons.NoLocaleNumberFormatter;
...
public class DlgParameterChartEdit extends DlgDirEdit < JFreeChart > {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.gss.dfpsearcher.DFPSearcherApp.class).getContext().getResourceMap(DlgParameterChartEdit.class);
        setTitle(resourceMap.getString("Form.title")); // NOI18N
        setModal(true);
        setName("Form"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ru.gss.dfpsearcher.DFPSearcherApp.class).getContext().getActionMap(DlgParameterChartEdit.class, this);
